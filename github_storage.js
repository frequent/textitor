/**
 * JIO Github Storage. Type = "github".
 * Github "git" storage.
 */
...
(function (jIO, RSVP, Blob, UriTemplate) {
  ...
  - a github storage would always setup a replicate with indexeddb (local)
    and github (remote), I could use cribjs appcache as (index/workspace)
  - saving a file only save it to appcache via cribjs
  - "commit" will jio.put a file to local
  - "push" button will jio.put a file from local to remote
  - the metadata is author, commit message, the file is attachement?
